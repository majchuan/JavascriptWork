 ...
 */
 var nextPermutation = function(nums) {
    ...
    // no rearrangements to the right of {firstNumberdescending - 1} can create a larger permutation since that subarray consists of numbers in 
    // descending order
    // need to replace the number nums[firstNumberdescending-1] with the number which is just larger than itself among the numbers 
    // lying to its right section
